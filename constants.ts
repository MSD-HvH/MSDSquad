type developingNames = ["Mased", "★scorpy_sterr★"];
type currentVersion = "1.0.0";
 ...
 * @since 21.03.2023
 */
export const version: currentVersion = "1.0.0";
 ...
 * @since 1.0.0
 */
export const devUsers: developingNames = ["Mased", "★scorpy_sterr★"];
