...
aux.HSV_to_RGB = function(h,s,v,a) {
    ...
    else if (h >= 241 && h < 301) {                 //ЕБАТЬ ЧЕ ЭТО ТАКОЕ ВООБЩЕ $$$
        r = (425 * (h-240))/100;
        g = 0;
        b = 255;
    }
...
menu.current_tab = 0
menu.current_subtab = []
menu.current_subtab_name = 0

menu.colors = {}
menu.color_theme = {}

menu.colors.MENU_SIDEBAR = [0, 0, 0, 0] //ЧЕ ЭТО ЗА ХУЙНЯ И ЧЕ ОНА ЗДЕСЬ ДЕЛАЕТ 
...
menu.color_theme['Cherry'] = {}
menu.color_theme['Cherry'].MAIN = [196, 106, 106, 255]
menu.color_theme['Cherry'].TAB_NOT_SELECTED = [124, 124, 124, 255]
menu.color_theme['Cherry'].MENU_SIDEBAR = [20, 15, 15, 255]
menu.color_theme['Cherry'].MENU_MAIN = [28, 23, 23, 255]
menu.color_theme['Cherry'].TEXT_SECOND = [124, 124, 124, 255]
menu.color_theme['Cherry'].ITEM_NAME = [124, 124, 124, 255]
menu.color_theme['Cherry'].ITEM_ENABLED = [230, 230, 230, 255]
menu.color_theme['Cherry'].CHECKBOX_DISABLED = menu.color_theme['Cherry'].MENU_SIDEBAR
menu.color_theme['Cherry'].CHECKBOX_ENABLED = menu.color_theme['Cherry'].MAIN
menu.color_theme['Cherry'].CHECKBOX_OUTLINE = [48, 40, 40, 255]
menu.color_theme['Cherry'].SLIDER_RECT = menu.color_theme['Cherry'].MENU_SIDEBAR
menu.color_theme['Cherry'].SLIDER_ENABLED = menu.color_theme['Cherry'].MAIN
menu.color_theme['Cherry'].SLIDER_OUTLINE = [48, 40, 40, 255]
menu.color_theme['Cherry'].DROPDOWN_RECT = menu.color_theme['Cherry'].MENU_SIDEBAR
menu.color_theme['Cherry'].DROPDOWN_OUTLINE = [48, 40, 40, 255]
menu.color_theme['Cherry'].COLORPICKER_OUTLINE = [48, 40, 40, 255]
menu.color_theme['Cherry'].COLORPICKER_PICKER = menu.color_theme['Cherry'].MENU_SIDEBAR
menu.color_theme['Cherry'].BUTTON_RECT = menu.color_theme['Cherry'].MENU_SIDEBAR
menu.color_theme['Cherry'].BUTTON_OUTLINE = [48, 40, 40, 255]

menu.color_theme['Gray'] = {}
menu.color_theme['Gray'].MAIN = [150, 150, 150, 255]
menu.color_theme['Gray'].TAB_NOT_SELECTED = [124, 124, 124, 255]
menu.color_theme['Gray'].MENU_SIDEBAR = [17, 17, 17, 255]
menu.color_theme['Gray'].MENU_MAIN = [25, 25, 25, 255]
menu.color_theme['Gray'].TEXT_SECOND = [124, 124, 124, 255]
menu.color_theme['Gray'].ITEM_NAME = [124, 124, 124, 255]
menu.color_theme['Gray'].ITEM_ENABLED = [230, 230, 230, 255]
menu.color_theme['Gray'].CHECKBOX_DISABLED = menu.color_theme['Gray'].MENU_SIDEBAR
menu.color_theme['Gray'].CHECKBOX_ENABLED = menu.color_theme['Gray'].MAIN
menu.color_theme['Gray'].CHECKBOX_OUTLINE = [44, 44, 44, 255]
menu.color_theme['Gray'].SLIDER_RECT = menu.color_theme['Gray'].MENU_SIDEBAR
menu.color_theme['Gray'].SLIDER_ENABLED = menu.color_theme['Gray'].MAIN
menu.color_theme['Gray'].SLIDER_OUTLINE = [44, 44, 44, 255]
menu.color_theme['Gray'].DROPDOWN_RECT = menu.color_theme['Gray'].MENU_SIDEBAR
menu.color_theme['Gray'].DROPDOWN_OUTLINE = [44, 44, 44, 255]
menu.color_theme['Gray'].COLORPICKER_OUTLINE = [44, 44, 44, 255]
menu.color_theme['Gray'].COLORPICKER_PICKER = menu.color_theme['Gray'].MENU_SIDEBAR
menu.color_theme['Gray'].BUTTON_RECT = menu.color_theme['Gray'].MENU_SIDEBAR
menu.color_theme['Gray'].BUTTON_OUTLINE = [44, 44, 44, 255]
...
menu.begin = function() {
    ...
    var SCRIPT_NAME_TEXT_SECOND_FONT = Render.GetFont('Segoeui.ttf', 13 * menu.dpi_scale, true)
    var TAB_TEXT_MAIN_FONT = Render.GetFont('Segoeuib.ttf', 20 * menu.dpi_scale, true)
    var SUBTAB_TEXT_MAIN_FONT = Render.GetFont('Segoeui.ttf',  10 * menu.dpi_scale, true)
    var SHORT_TAB_NAME_FONT = Render.GetFont('Segoeuib.ttf', 10 * menu.dpi_scale, true)
    var ITEM_NAME = Render.GetFont('Segoeui.ttf', 11 * menu.dpi_scale, true)
    var SLIDER_VALUE = Render.GetFont('Segoeui.ttf', 11 * menu.dpi_scale, true)
    ...
    if (!menu.tab_size[menu.current_tab]) {
        menu.tab_size[menu.current_tab] = []
    }

    var menu_size_anim = visuals.new_animation('menu size anim', Math.max(menu.current_size, menu.tab_offset))
    ...
    var SUBTAB_INDENT = TAB_INDENT * menu.dpi_scale
    ...
    var SCRIPT_NAME_TEXT_SECOND_SIZE = Render.TextSize(script.name, SCRIPT_NAME_TEXT_SECOND_FONT)
    Render.String(menu.position[0] + MENU_SIDEBAR[0] + MENU_MAIN_INDENT, menu.position[1] + MENU_MAIN_INDENT - 2, 0, script.name, menu.colors.TEXT_SECOND, SCRIPT_NAME_TEXT_SECOND_FONT)

    var DROPDOWNS = []
    var COLORPICKERS = []

    var TAB_INTERACTION_PERMISSION = global_alpha > 0.5 && IS_MENU_OPEN
    //Я НЕ ПИДОРАС НИ В КОЕМ СЛУЧАЕ 
    ...
    for (i in menu.items) {
        ...
        var SHORT_TAB_NAME_SIZE = Render.TextSize(tab.name, SHORT_TAB_NAME_FONT)

        Render.String(menu.position[0] + TAB_SIZE[0] / 2 - SHORT_TAB_NAME_SIZE[0] / 2, menu.position[1] + PER_TABS_OFFSET + TAB_SIZE[1] / 2 - SHORT_TAB_NAME_SIZE[1] / 2 - 2, 0, tab.name, menu.current_tab == i ? menu.colors.MAIN : menu.colors.TAB_NOT_SELECTED, SHORT_TAB_NAME_FONT)
        ...
        var TAB_NAME_TEXT = Render.TextSize(tab.name.toLowerCase(), TAB_TEXT_MAIN_FONT)
        Render.String(menu.position[0] + MENU_SIDEBAR[0] + MENU_MAIN_INDENT, menu.position[1] + MENU_MAIN_INDENT + SCRIPT_NAME_TEXT_SECOND_SIZE[1] - 2, 0, tab.name.toLowerCase(), aux.multiply_alpha(menu.colors.MAIN, TAB_NAME_ALPHA), TAB_TEXT_MAIN_FONT)

        var TAB_NAME_SIZE = Render.TextSize(tab.name.toLowerCase(), TAB_TEXT_MAIN_FONT)

        var PER_ITEMS_OFFSET = 0
        var TAB_HEIGHT = 0
        var PER_SUBTABS_OFFSET = []

        if (!PER_SUBTABS_OFFSET[i]) {
            PER_SUBTABS_OFFSET[i] = SUBTAB_INDENT
        }
        //ротоёбина 
        ...
        for (p in tab.items) {
            ...
            var subtab = tab.items[p]

            if (!menu.current_subtab[i]) {
                menu.current_subtab[i] = 0
            }

            var SUBTAB_NAME_ALPHA = visuals.new_animation(i + p + ' SUBTAB NAME ALPHA', TAB_INTERACTION_PERMISSION && menu.current_tab == i ? 1 : 0)
            
            var SUBTAB_INTERACTION_PERMISSION = TAB_INTERACTION_PERMISSION && SUBTAB_NAME_ALPHA > 0.5

            var SUBTAB_NAME_SIZE = Render.TextSize(subtab.name.toLowerCase(), SUBTAB_TEXT_MAIN_FONT)
            Render.String(menu.position[0] + MENU_SIDEBAR[0] + MENU_MAIN[0] - SUBTAB_NAME_SIZE[0] - MENU_MAIN_INDENT - PER_SUBTABS_OFFSET[i], menu.position[1] + MENU_MAIN_INDENT + SCRIPT_NAME_TEXT_SECOND_SIZE[1] - 2 + TAB_NAME_SIZE[1] / 2, 0, subtab.name.toLowerCase(), aux.multiply_alpha(menu.current_subtab[i] == p ? menu.colors.MAIN : menu.colors.TAB_NOT_SELECTED, SUBTAB_NAME_ALPHA), SUBTAB_TEXT_MAIN_FONT)
            
            if (!menu.tab_size[i][p]) {
                menu.tab_size[i][p] = 0
            }

            if (input_system.is_key_pressed(0x01) && TAB_INTERACTION_PERMISSION && menu.current_tab == i && SUBTAB_NAME_ALPHA > 0.8) {

                if (aux.in_bounds([menu.position[0] + MENU_SIDEBAR[0] + MENU_MAIN[0] - SUBTAB_NAME_SIZE[0] - MENU_MAIN_INDENT - PER_SUBTABS_OFFSET[i], menu.position[1] + MENU_MAIN_INDENT + SCRIPT_NAME_TEXT_SECOND_SIZE[1] + TAB_NAME_SIZE[1] / 2], SUBTAB_NAME_SIZE, CURSOR_POSITION)) {
                    menu.current_subtab[i] = p
                    menu.current_subtab_name = p
                }
    
            }

            for (j in subtab.items) {
            
                var item = subtab.items[j]
                ...
                var ITEM_INTERACTION_PERMISSION = TAB_INTERACTION_PERMISSION && SUBTAB_INTERACTION_PERMISSION && item.tab == menu.current_tab && item.subtab == menu.current_subtab[i] && VISIBILITY_CONDITION 
                ...
                if (item.type == 'checkbox') {
                    ...
                    var CHECKBOX_NAME_SIZE = Render.TextSize(item.name, ITEM_NAME)
                    Render.String(menu.position[0] + MENU_SIDEBAR[0] + MENU_MAIN_INDENT + CHECKBOX_SIZE[0] + CHECKBOX_NAME_INDENT, menu.position[1] + MENU_MAIN_INDENT + SCRIPT_NAME_TEXT_SECOND_SIZE[1] + TAB_NAME_TEXT[1] + MENU_MAIN_INDENT + PER_ITEMS_OFFSET, 0, item.name, TEXT_COLOR, ITEM_NAME)
                    ...
                    var SLIDER_NAME_SIZE = Render.TextSize(item.name, ITEM_NAME)
                    Render.String(menu.position[0] + MENU_SIDEBAR[0] + MENU_MAIN_INDENT, menu.position[1] + MENU_MAIN_INDENT + SCRIPT_NAME_TEXT_SECOND_SIZE[1] + TAB_NAME_TEXT[1] + MENU_MAIN_INDENT + PER_ITEMS_OFFSET - 2, 0, item.name, TEXT_COLOR, ITEM_NAME)
    
                    var SLIDER_VALUE_SIZE = Render.TextSize((item.value).toString(), ITEM_NAME)
                    Render.String(menu.position[0] + MENU_SIDEBAR[0] + MENU_MAIN_INDENT + SLIDER_SIZE[0] - SLIDER_VALUE_SIZE[0], menu.position[1] + MENU_MAIN_INDENT + SCRIPT_NAME_TEXT_SECOND_SIZE[1] + TAB_NAME_TEXT[1] + MENU_MAIN_INDENT + PER_ITEMS_OFFSET - 2, 0, (item.value).toString(), TEXT_COLOR, ITEM_NAME)
                    ...
                    var DROPDOWN_NAME_SIZE = Render.TextSize(item.name, ITEM_NAME)
                    Render.String(menu.position[0] + MENU_SIDEBAR[0] + MENU_MAIN_INDENT, menu.position[1] + MENU_MAIN_INDENT + SCRIPT_NAME_TEXT_SECOND_SIZE[1] + TAB_NAME_TEXT[1] + MENU_MAIN_INDENT + PER_ITEMS_OFFSET - 2, 0, item.name, TEXT_COLOR, ITEM_NAME)
                    ...
                    var DROPDOWN_VALUE_SIZE = Render.TextSize(item.options[item.value], ITEM_NAME)
                    Render.String(menu.position[0] + MENU_SIDEBAR[0] + MENU_MAIN_INDENT + DROPDOWN_VALUE_TEXT_INDENT, menu.position[1] + MENU_MAIN_INDENT + SCRIPT_NAME_TEXT_SECOND_SIZE[1] + TAB_NAME_TEXT[1] + MENU_MAIN_INDENT + PER_ITEMS_OFFSET + DROPDOWN_TEXT_INDENT + DROPDOWN_SIZE[1] / 2 - DROPDOWN_VALUE_SIZE[1] / 2 - 2, 0, item.options[item.value], VALUE_COLOR, ITEM_NAME)
    
                    if (DROPDOWN_ALPHA > 0) {
    
                        for (q in item.options) {
     
                            var IS_SELECTED = q == item.value
                    ...
                    var DROPDOWN_VALUE_SIZE = Render.TextSize(new_values, ITEM_NAME)
                    new_values = DROPDOWN_VALUE_SIZE[0] > (DROPDOWN_SIZE[0] - DROPDOWN_VALUE_TEXT_INDENT * 2) ? new_values.substring(0, 30) + '...' : new_values
                    Render.String(menu.position[0] + MENU_SIDEBAR[0] + MENU_MAIN_INDENT + DROPDOWN_VALUE_TEXT_INDENT, menu.position[1] + MENU_MAIN_INDENT + SCRIPT_NAME_TEXT_SECOND_SIZE[1] + TAB_NAME_TEXT[1] + MENU_MAIN_INDENT + PER_ITEMS_OFFSET + DROPDOWN_TEXT_INDENT + DROPDOWN_SIZE[1] / 2 - DROPDOWN_VALUE_SIZE[1] / 2 - 2, 0, new_values, VALUE_COLOR, ITEM_NAME)
                    ...
                    var COLORPICKER_NAME_SIZE = Render.TextSize(item.name, ITEM_NAME)
                    Render.String(menu.position[0] + MENU_SIDEBAR[0] + MENU_MAIN_INDENT + COLORPICKER_SIZE[0] + COLORPICKER_NAME_INDENT, menu.position[1] + MENU_MAIN_INDENT + SCRIPT_NAME_TEXT_SECOND_SIZE[1] + TAB_NAME_TEXT[1] + MENU_MAIN_INDENT + PER_ITEMS_OFFSET, 0, item.name, TEXT_COLOR, ITEM_NAME)
                    ...
                    var NAME_SIZE = Render.TextSize(item.name, ITEM_NAME)
                    //Render.String(menu.position[0] + MENU_SIDEBAR[0] + MENU_MAIN_INDENT + BUTTON_NAME_INDENT, menu.position[1] + MENU_MAIN_INDENT + SCRIPT_NAME_TEXT_SECOND_SIZE[1] + TAB_NAME_TEXT[1] + MENU_MAIN_INDENT + PER_ITEMS_OFFSET + BUTTON_SIZE[1] / 2 - NAME_SIZE[1] / 2 - 2, 0, item.name, TEXT_COLOR, ITEM_NAME)
    
                    Render.String(menu.position[0] + MENU_SIDEBAR[0] + MENU_MAIN_INDENT + BUTTON_SIZE[0] / 2, menu.position[1] + MENU_MAIN_INDENT + SCRIPT_NAME_TEXT_SECOND_SIZE[1] + TAB_NAME_TEXT[1] + MENU_MAIN_INDENT + PER_ITEMS_OFFSET + BUTTON_SIZE[1] / 2 - NAME_SIZE[1] / 2 - 2, 1, item.name, TEXT_COLOR, ITEM_NAME)
    
                    if (aux.in_bounds([menu.position[0] + MENU_SIDEBAR[0] + MENU_MAIN_INDENT, menu.position[1] + MENU_MAIN_INDENT + SCRIPT_NAME_TEXT_SECOND_SIZE[1] + TAB_NAME_TEXT[1] + MENU_MAIN_INDENT + PER_ITEMS_OFFSET], BUTTON_SIZE, CURSOR_POSITION) && input_system.is_key_pressed(0x01) && ITEM_INTERACTION_PERMISSION && !is_something_open()) {
                        item.func()
                    }
                ...
                menu.tab_size[i][p] = MENU_MAIN_INDENT + SCRIPT_NAME_TEXT_SECOND_SIZE[1] + TAB_NAME_TEXT[1] + MENU_MAIN_INDENT + PER_ITEMS_OFFSET + MENU_MAIN_INDENT / 2
                menu.current_size = menu.tab_size[menu.current_tab][menu.current_subtab[menu.current_tab]]

                //шлючья дочь 

            }
            PER_SUBTABS_OFFSET[i] = PER_SUBTABS_OFFSET[i] + SUBTAB_NAME_SIZE[0] + MENU_MAIN_INDENT / 2
        }
    ...
    for (DROPDOWN_ID in DROPDOWNS) {
        ...
        for (i in DROPDOWN.item.options) {
            ...
            if (typeof(DROPDOWN.item.value) == 'object') {
                ...
                var OPTION_NAME_SIZE = Render.TextSize(DROPDOWN.item.options[i], ITEM_NAME)
                ...
                Render.String(DROPDOWN.position[0] + DROPDOWN_VALUE_TEXT_INDENT, DROPDOWN.position[1] + DROPDOWN_SIZE[1] / 2 - OPTION_NAME_SIZE[1] / 2 - 2 + OPTIONS_OFFSET, 0, DROPDOWN.item.options[i], aux.multiply_alpha(OPTION_NAME_COLOR, DROPDOWN.DROPDOWN_ALPHA * DROPDOWN.ITEM_ALPHA), ITEM_NAME)
            }
            else {
...
menu.add_subtab = function(tab, name, short_name) {
...
menu.add_checkbox = function(tab, subtab, name, def, visibility_condition) {
    ...
    for (i in menu.items) {
        ...
        if (current_tab.name == tab) {
            ...
            for (j in current_tab.items) {
                ...
                var current_subtab = current_tab.items[j]

                if (current_subtab.name == subtab) {

                    current_subtab.items.push({
                        type : 'checkbox',
                        tab : i,
                        subtab : j,
                        name : name,
...
menu.add_slider = function(tab, subtab, name, min, max, def, visibility_condition) {
...
menu.add_dropdown = function(tab, subtab, name, options, def, visibility_condition) {
...
menu.add_multidropdown = function(tab, subtab, name, options, def, visibility_condition) {
...
menu.add_colorpicker = function(tab, subtab, name, def, visibility_condition) {
...
menu.add_button = function(tab, subtab, name, func, visibility_condition) {
        ...
        if (current_tab.name == tab) {
            ...
            for (j in current_tab.items) {
                ...
                if (current_subtab.name == subtab) {
                    ...
                    for (j in current_subtab.items) {

                        var current_item = current_subtab.items[j]
...
menu.set = function(tab, subtab, name, value) {
            ...
            for (j in current_tab.items) {
                ...
                if (current_subtab.name == subtab) {
                    ...
                    for (j in current_subtab.items) {
                        ...
                        if (current_item.type == 'dropdown' && current_item.name == name) {
                            current_item.options = new_table
...
menu.add_tab('ABF.')
menu.add_subtab('ABF.', 'Main')

menu.add_tab('Misc.')
menu.add_subtab('Misc.', 'Main')

menu.add_tab('Configs')
menu.add_subtab('Configs', 'Main')
...
visuals.start_render = function() {
    ...
    //var theme = ['Default', 'Midnight', 'Cherry', 'Gray']
    //menu.colors.current_theme = theme[menu.get_value('Script', 'Main77', 'theme')]

    //menu.dpi_scale = menu.dpi_scales[menu.get_value('Script', 'Main77', 'dpi scale')]
