...
menu.begin = function() {
    ...
    var SHORT_TAB_NAME_FONT = Render.GetFont('Segoeuib.ttf', 13 * menu.dpi_scale, true)
    ...
    for (i in menu.items) {
        ...
        var SHORT_TAB_NAME_SIZE = Render.TextSize(tab.short_name, SHORT_TAB_NAME_FONT)

        Render.String(menu.position[0] + TAB_SIZE[0] / 2 - SHORT_TAB_NAME_SIZE[0] / 2, menu.position[1] + PER_TABS_OFFSET + TAB_SIZE[1] / 2 - SHORT_TAB_NAME_SIZE[1] / 2 - 2, 0, tab.short_name, menu.current_tab == i ? menu.colors.MAIN : menu.colors.TAB_NOT_SELECTED, SHORT_TAB_NAME_FONT)
