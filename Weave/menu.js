...
var UI = {
    AddCheckbox: function(pos, x, y, name, varname) {
        ...
        render.filled_rect([x, y], [40, 15], [30, 30, 30, 155], 4)
    ...
    AddColorPicker: function(pos, x, y, name, varname) {
        var alpha = ui.get_menu_alpha()
        if(alpha < 0.9) return
    ...
    AddSlider: function(pos, x, y, name, varname, min, max) {
        var alpha = ui.get_menu_alpha()
        if(alpha < 0.9) return
    ...
    AddCombobox: function(pos, x, y, name, varname, elements) {
        var alpha = ui.get_menu_alpha()
        if(alpha < 0.9) return
...
function menu() {
    ...
    UI.AddCheckbox(pos, x + 10, y + 65, "Console.log", "log")
    UI.AddCheckbox(pos, x + 10, y + 105, "Rect", "rect")
    UI.AddCheckbox(pos, x + 80, y + 65, "Rect2", "rect2")
    UI.AddCheckbox(pos, x + 80, y + 105, "Rect3 + slider", "rect3")
    UI.AddSlider(pos, x + 10, y + 230, "Slider for rect3", "slider", 30, screen[0])
    UI.AddColorPicker(pos, x + 80, y + 145, "Color3", "RectColor3")
    UI.AddColorPicker(pos, x + 10, y + 185, "Color2", "RectColor2")
    UI.AddColorPicker(pos, x + 10, y + 145, "Color", "RectColor")
    UI.AddCombobox(pos, x + 160, y + 65, "Combobox", "combobox", ["None", "White", "Purple", "Orange", "Pink"])
